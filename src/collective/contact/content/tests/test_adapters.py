...
class TestAdapters(unittest.TestCase, BaseTest):
    ...
    def test_held_position_vcard(self):
        ...
        self.assertEqual(unicode(vcard.org.value), u'Armée de terre')
        self.assertEqual(unicode(vcard.role.value), u'General of armée de terre')
        self.assertEqual(unicode(vcard.title.value), u'General of armée de terre')
